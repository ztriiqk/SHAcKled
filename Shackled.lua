...
--Timers 
    local Timers = {}
        ...
        local DMGTimer, RVankaTimer1, ExitTimer, autoC, autoCRestore
--
--Vectors
...
--! Tables
    ...
    --CFG
        ...
        local Vehicle = {
                Hydra = {
                    FastLock = { 
                        Lock = ImBool(false),
                        LockDelay = ImInt(1500),
                        Visual = ImBool(false),
                        VisualDelay = ImInt(1500)
                    },
                    Thrust = {
                        Enable = ImBool(false), 
                        Key = ImInt(49),
        ...
        local Movement = {
                Slide = {
                        ...
                        DontSwitchWeap1 = ImBool(false),
                        PrioritizeFist2handedgun = ImBool(false),
                        DontSwitchWeap2 = ImBool(false),
    ...
    local weaponInfo = {}
        weaponInfo[0] =  { id = 0,  slot = 0,  name = "Fist",                     distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 1136, animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = false}
        weaponInfo[1] =  { id = 1,  slot = 0,  name = "Brass Knuckles",           distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 1136, animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = false}
        weaponInfo[2] =  { id = 2,  slot = 1,  name = "Golf Club",                distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 17,   animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = false }
        weaponInfo[3] =  { id = 3,  slot = 1,  name = "Nitestick",                distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 19,   animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = false }
        weaponInfo[4] =  { id = 4,  slot = 1,  name = "Knife",                    distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 751,  animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = false }
        weaponInfo[5] =  { id = 5,  slot = 1,  name = "Bat",                      distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 17,   animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = true }
        weaponInfo[6] =  { id = 6,  slot = 1,  name = "Shovel",                   distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 17,   animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = true }
        weaponInfo[7] =  { id = 7,  slot = 1,  name = "Pool Cue",                 distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 17,   animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = true }
        weaponInfo[8] =  { id = 8,  slot = 1,  name = "Katana",                   distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 1545, animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = false }
        weaponInfo[9] =  { id = 9,  slot = 1,  name = "Chainsaw",                 distance = 1.6,   damage = 27.060001, own = false, ammo = 0, clipammo = 0, animations = 320,  animationsflag = 32772, weaponstate = 0, cammode = 4,  twohanded = true }
        weaponInfo[10] = { id = 10, slot = 10, name = "Purple Dildo",             distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 423,  animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = false }
        weaponInfo[11] = { id = 11, slot = 10, name = "Dildo",                    distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 749,  animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = false }
        weaponInfo[12] = { id = 12, slot = 10, name = "Vibrator",                 distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 423,  animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = false }
        weaponInfo[13] = { id = 13, slot = 10, name = "Silver Vibrator",          distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 749,  animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = false }
        weaponInfo[14] = { id = 14, slot = 10, name = "Flowers",                  distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 533,  animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = false }
        weaponInfo[15] = { id = 15, slot = 10, name = "Cane",                     distance = 1.6,   damage = 5.28,      own = false, ammo = 0, clipammo = 0, animations = 1547, animationsflag = 32776, weaponstate = 0, cammode = 4,  twohanded = false }
        weaponInfo[16] = { id = 16, slot = 8,  name = "Grenade",                  distance = 40.0,  damage = 82.5,      own = false, ammo = 0, clipammo = 0, animations = 644,  animationsflag = 32784, weaponstate = 1, cammode = 4,  twohanded = false }
        weaponInfo[17] = { id = 17, slot = 8,  name = "Teargas",                  distance = 40.0,  damage = 0.0,       own = false, ammo = 0, clipammo = 0, animations = 644,  animationsflag = 32784, weaponstate = 1, cammode = 4,  twohanded = false }
        weaponInfo[18] = { id = 18, slot = 8,  name = "Molotov",                  distance = 40.0,  damage = 1.0,       own = false, ammo = 0, clipammo = 0, animations = 644,  animationsflag = 32784, weaponstate = 1, cammode = 4,  twohanded = false }
        weaponInfo[19] = { id = 19, slot = -1, name = "Vehicle M4 (custom)",      distance = 90.0,  damage = 9.9,       own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 0, cammode = 18, twohanded = true }
        weaponInfo[20] = { id = 20, slot = -1, name = "Vehicle Minigun (custom)", distance = 75.0,  damage = 46.2,      own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 0, cammode = 18, twohanded = true }
        weaponInfo[21] = { id = 21, slot = -1, name = "Vehicle Rocket (custom)",  distance = 300,   damage = 82.5,      own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 0, cammode = 18, twohanded = true }
        weaponInfo[22] = { id = 22, slot = 2,  name = "Colt",                     distance = 35.0,  damage = 8.25,      own = false, ammo = 0, clipammo = 0, animations = 363,  animationsflag = 32766, weaponstate = 2, cammode = 53, twohanded = false }
        weaponInfo[23] = { id = 23, slot = 2,  name = "Silenced",                 distance = 35.0,  damage = 13.200001, own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32766, weaponstate = 2, cammode = 53, twohanded = false}
        weaponInfo[24] = { id = 24, slot = 2,  name = "Desert Eagle",             distance = 35.0,  damage = 46.200001, own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32766, weaponstate = 2, cammode = 53, twohanded = false}
        weaponInfo[25] = { id = 25, slot = 3,  name = "Shotgun",                  distance = 40.0,  damage = 49.500004, own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32766, weaponstate = 2, cammode = 53, twohanded = true }
        weaponInfo[26] = { id = 26, slot = 3,  name = "Sawnoff",                  distance = 35.0,  damage = 49.500004, own = false, ammo = 0, clipammo = 0, animations = 363,  animationsflag = 32766, weaponstate = 2, cammode = 53, twohanded = false}
        weaponInfo[27] = { id = 27, slot = 3,  name = "Spas",                     distance = 40.0,  damage = 29.700001, own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32766, weaponstate = 2, cammode = 53, twohanded = true }
        weaponInfo[28] = { id = 28, slot = 4,  name = "Uzi",                      distance = 35.0,  damage = 6.6,       own = false, ammo = 0, clipammo = 0, animations = 363,  animationsflag = 32766, weaponstate = 2, cammode = 53, twohanded = false }
        weaponInfo[29] = { id = 29, slot = 4,  name = "Mp5",                      distance = 45.0,  damage = 8.25,      own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32766, weaponstate = 2, cammode = 53, twohanded = false }
        weaponInfo[30] = { id = 30, slot = 5,  name = "Ak47",                     distance = 70.0,  damage = 9.900001,  own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32766, weaponstate = 2, cammode = 53, twohanded = true }
        weaponInfo[31] = { id = 31, slot = 5,  name = "M4",                       distance = 90.0,  damage = 9.900001,  own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32766, weaponstate = 2, cammode = 53, twohanded = true }
        weaponInfo[32] = { id = 32, slot = 4,  name = "Tec9",                     distance = 35.0,  damage = 6.6,       own = false, ammo = 0, clipammo = 0, animations = 363,  animationsflag = 32766, weaponstate = 2, cammode = 53, twohanded = false }
        weaponInfo[33] = { id = 33, slot = 6,  name = "Country Rifle",            distance = 100.0, damage = 24.750002, own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32766, weaponstate = 3, cammode = 53, twohanded = true }
        weaponInfo[34] = { id = 34, slot = 6,  name = "Sniper",                   distance = 320.0, damage = 41.25,     own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32766, weaponstate = 3, cammode = 7,  twohanded = true }
        weaponInfo[35] = { id = 35, slot = 7,  name = "Rocket Launcher",          distance = 55.0,  damage = 82.5,      own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32776, weaponstate = 3, cammode = 8,  twohanded = true }
        weaponInfo[36] = { id = 36, slot = 7,  name = "HeatSeeker",               distance = 55.0,  damage = 82.5,      own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32776, weaponstate = 3, cammode = 51, twohanded = true }
        weaponInfo[37] = { id = 37, slot = 7,  name = "Flamethrower",             distance = 5.1,   damage = 1.0,       own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32776, weaponstate = 2, cammode = 53, twohanded = true }
        weaponInfo[38] = { id = 38, slot = 7,  name = "Minigun",                  distance = 75.0,  damage = 46.2,      own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32766, weaponstate = 2, cammode = 53, twohanded = true }
        weaponInfo[39] = { id = 39, slot = 8,  name = "Satchel",                  distance = 40.0,  damage = 82.5,      own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 1, cammode = 4,  twohanded = false }
        weaponInfo[40] = { id = 40, slot = 12, name = "Detonator",                distance = 25.0,  damage = 0.0,       own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 1, cammode = 4,  twohanded = false }
        weaponInfo[41] = { id = 41, slot = 9,  name = "Spraycan",                 distance = 6.1,   damage = 0.33,      own = false, ammo = 0, clipammo = 0, animations = 1164, animationsflag = 32776, weaponstate = 2, cammode = 53, twohanded = false }
        weaponInfo[42] = { id = 42, slot = 9,  name = "Extinguisher",             distance = 10.1,  damage = 0.33,      own = false, ammo = 0, clipammo = 0, animations = 1167, animationsflag = 32776, weaponstate = 2, cammode = 53, twohanded = true }
        weaponInfo[43] = { id = 43, slot = 9,  name = "Camera",                   distance = 100.0, damage = 0.0,       own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 2, cammode = 46, twohanded = false }
        weaponInfo[44] = { id = 44, slot = 11, name = "Night Vision",             distance = 100.0, damage = 0.0,       own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 0, cammode = 4,  twohanded = false }
        weaponInfo[45] = { id = 45, slot = 11, name = "Thermal Vision",           distance = 100.0, damage = 0.0,       own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 0, cammode = 4,  twohanded = false }
        weaponInfo[46] = { id = 46, slot = 11, name = "Parachute",                distance = 1.6,   damage = 0.0,       own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 0, cammode = 4,  twohanded = false }
        weaponInfo[47] = { id = 47, slot = -1, name = "Cellphone",                distance = 300.0, damage = 0.0,       own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 0, cammode = 0, twohanded = false }
        weaponInfo[48] = { id = 48, slot = -1, name = "Jetpack",                  distance = 300.0, damage = 0.0,       own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 0, cammode = 0, twohanded = false }
        weaponInfo[49] = { id = 49, slot = -1, name = "Vehicle",                  distance = 300.0, damage = 0.0,       own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 0, cammode = 0, twohanded = false }
        weaponInfo[50] = { id = 50, slot = -1, name = "Helicopter Blades",        distance = 300.0, damage = 0.0,       own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 0, cammode = 0, twohanded = false }
        weaponInfo[51] = { id = 51, slot = -1, name = "Random",                   distance = 300.0, damage = 0.0,       own = false, ammo = 0, clipammo = 0, animations = 0,    animationsflag = 0,     weaponstate = 0, cammode = 0, twohanded = false }
    local fWeaponName = ""
    ...
    local m_offsets = {}--          r1         r2        r3        r4        r4-2      0.3dl     r5
        m_offsets.m_samp_info =   { 0x21A0F8,  0x21A100, 0x26E8DC, 0x26EA0C, 0x26EA0C, 0x2ACA24, 0x26EB94  }
        m_offsets.m_settings =    { 0x3C5,     0x03C1,   0x3D5,    0x3DE,    0x3DE,    0x3D5,    0x3DE     }
        ...
        m_offsets.m_pickup =      { 0x20,      0x10,     0x10,     0x10,     0x8,      0x10,     0x8       }
...
--! Variables
    local v = {
            EmulateC = 0,
            AutoReplyTeleportDelayText = nil,
            AutoReplyTeleportDelay = 0,
...
--! Functions
    ...
    function read.BufferFromString(var, varcheck, value)
            ...
            return ImBuffer(tostring(value), 255)
        end
    --SaveAsString
        ...
        function Movement.SaveAsString()
                ...
                output = output .. string.format("Movement.Slide.DontSwitchWeap1 = %s", Movement.Slide.DontSwitchWeap1.v) .. "\n"
                output = output .. string.format("Movement.Slide.PrioritizeFist2handedgun = %s", Movement.Slide.PrioritizeFist2handedgun.v) .. "\n"
                output = output .. string.format("Movement.Slide.DontSwitchWeap2 = %s", Movement.Slide.DontSwitchWeap2.v) .. "\n"
                ...
                output = output .. string.format("Movement.NoRam = %s",Movement.NoRam.v) .. "\n"
        ...
        function Extra.SaveAsString()
                local output = ""
                output = output .. string.format("Extra.AutoC.Enable = %s",Extra.AutoC.Enable.v) .. "\n"
                output = output .. string.format("Extra.AutoC.Type = %d",Extra.AutoC.Type.v) .. "\n"
                ...
                output = output .. string.format("Extra.SendCMD.FirstDelay = %d",Extra.SendCMD.FirstDelay.v) .. "\n"
        ...
        function Vehicle.SaveAsString()
                ...
                output = output .. string.format("Vehicle.Hydra.FastLock.LockDelay = %d", Vehicle.Hydra.FastLock.LockDelay.v) .. "\n"
                output = output .. string.format("Vehicle.Hydra.FastLock.Visual = %s", Vehicle.Hydra.FastLock.Visual.v) .. "\n"
                output = output .. string.format("Vehicle.Hydra.FastLock.VisualDelay = %d", Vehicle.Hydra.FastLock.VisualDelay.v) .. "\n"
                ...
                output = output .. string.format("Vehicle.FastExit.Enable = %s",Vehicle.FastExit.Enable.v) .. "\n" 
                output = output .. string.format("Vehicle.FastExit.Type = %d",Vehicle.FastExit.Type.v) .. "\n" 
                output = output .. string.format("Vehicle.FastExit.Delay = %d",Vehicle.FastExit.Delay.v) .. "\n" 
                ...
                output = output .. string.format("Vehicle.Bike.Enable = %s",Vehicle.Bike.Enable.v) .. "\n"
                output = output .. string.format("Vehicle.Bike.Delay = %d",Vehicle.Bike.Delay.v) .. "\n"
                output = output .. string.format("Vehicle.Bicycle.Enable = %s",Vehicle.Bicycle.Enable.v) .. "\n"
                output = output .. string.format("Vehicle.Bicycle.Delay = %d",Vehicle.Bicycle.Delay.v) .. "\n"
                return output
            end
        ...
        function SHAkMenu.SaveAsString()
                local output = ""
                output = output .. string.format("SHAkMenu.Unload = %s",SHAkMenu.Unload.v).. "\n"
    ...
    function read.LoadFromString(s)
            ...
            for line in s:gmatch("([^\n]*)\n?") do
                ...
                local variable, values = string.match(line, "(.-)%s*=%s*(.+)")
                local var = variable
                local value = values
                --local value1 = values[3]
                --local value2 = values[3]
                var1[index] = splitted[1]
                var2[index] = 0
                lines[index] = values
                index = index + 1
            end
                ...
                Movement.Slide.DontSwitchWeap1 = read.BoolFromString(var1[cfglines],"Movement.Slide.DontSwitchWeap1",lines[cfglines]) cfglines = cfglines + 1
                ...
                Movement.Slide.DontSwitchWeap2 = read.BoolFromString(var1[cfglines],"Movement.Slide.DontSwitchWeap2",lines[cfglines]) cfglines = cfglines + 1
                ...
                Movement.NoRam = read.BoolFromString(var1[cfglines],"Movement.NoRam",lines[cfglines]) cfglines = cfglines + 1
                ...
                Extra.AutoC.Enable = read.BoolFromString(var1[cfglines],"Extra.AutoC.Enable",lines[cfglines]) cfglines = cfglines + 1
                Extra.AutoC.Type = read.IntFromString(var1[cfglines],"Extra.AutoC.Type",lines[cfglines]) cfglines = cfglines + 1
                ...
                Extra.SendCMD.FirstDelay = read.IntFromString(var1[cfglines],"Extra.SendCMD.FirstDelay",lines[cfglines]) cfglines = cfglines + 1
                ...
                Vehicle.Hydra.FastLock.LockDelay = read.IntFromString(var1[cfglines],"Vehicle.Hydra.FastLock.LockDelay",lines[cfglines]) cfglines = cfglines + 1
                ...
                Vehicle.Hydra.FastLock.VisualDelay = read.IntFromString(var1[cfglines],"Vehicle.Hydra.FastLock.VisualDelay",lines[cfglines]) cfglines = cfglines + 1
                ...
                Vehicle.FastExit.Enable = read.BoolFromString(var1[cfglines],"Vehicle.FastExit.Enable",lines[cfglines]) cfglines = cfglines + 1
                Vehicle.FastExit.Type = read.IntFromString(var1[cfglines],"Vehicle.FastExit.Type",lines[cfglines]) cfglines = cfglines + 1
                Vehicle.FastExit.Delay = read.IntFromString(var1[cfglines],"Vehicle.FastExit.Delay",lines[cfglines]) cfglines = cfglines + 1
                ...
                Vehicle.Bike.Enable = read.BoolFromString(var1[cfglines],"Vehicle.Bike.Enable",lines[cfglines]) cfglines = cfglines + 1
                Vehicle.Bike.Delay = read.IntFromString(var1[cfglines],"Vehicle.Bike.Delay",lines[cfglines]) cfglines = cfglines + 1
                Vehicle.Bicycle.Enable = read.BoolFromString(var1[cfglines],"Vehicle.Bicycle.Enable",lines[cfglines]) cfglines = cfglines + 1
                Vehicle.Bicycle.Delay = read.IntFromString(var1[cfglines],"Vehicle.Bicycle.Delay",lines[cfglines]) cfglines = cfglines + 1
                ...
                SHAkMenu.Unload = read.BoolFromString(var1[cfglines],"SHAkMenu.Unload",lines[cfglines]) cfglines = cfglines + 1
    ...
    --Weapon
        function get.ChangeWeapon(weapon, sametype)
                ...
                local WeaponID = 0
                if IsWeaponTwoHanded and not Movement.Slide.DontSwitchWeap2.v or not IsWeaponTwoHanded and not Movement.Slide.DontSwitchWeap1.v then
    ...
    --Object & Vehicles
        function set.HydraLockOnDelay(LockOn, Visual)
                if LockOn == true then
                    Utils:writeMemory(0x6E363A, Vehicle.Hydra.FastLock.LockDelay.v, 4, false) -- Actual Lock On
                else
                    Utils:writeMemory(0x6E363A, 1500, 4, false)
                end
                if Visual == true then
                    Utils:writeMemory(0x6E36FB, Vehicle.Hydra.FastLock.VisualDelay.v, 4, false) -- Only Visual
                else
        ...
        function get.PickupPool()
                local SAMP_INFO_OFFSET = v.SampAdr + m_offsets.m_samp_info[v.SampVer]  
                SAMP_INFO_OFFSET = Utils:readMemory(SAMP_INFO_OFFSET, 4, false)
                local SAMP_PPOOLS_OFFSET = SAMP_INFO_OFFSET + m_offsets.m_pools[v.SampVer]  
                SAMP_PPOOLS_OFFSET = Utils:readMemory(SAMP_PPOOLS_OFFSET, 4, false)
                local SAMP_PPOOL_PICKUP_OFFSET = SAMP_PPOOLS_OFFSET + m_offsets.m_pickup[v.SampVer]  
        ...
        function get.VehicleFromPool(nId)
                local cnetgame = Utils:readMemory(v.SampAdr + m_offsets.m_samp_info[v.SampVer], 4, false)
                local cpools = Utils:readMemory(cnetgame + m_offsets.m_pools[v.SampVer], 4, false)
                ...
                if Players:isPlayerStreamed(playerID) then
                    ...
                    --if v.WaitForPickLag == 0 then
                        ...
                        if(velocityMagnitude > 0) then
                            ...
                            local speed = (velocityMagnitude * 0.1) * 0.5 * 1500
                            local t = 1.0;
    ...
    --Local Player
        ...
        function set.PlayerAnimation(animlib, animname)
                local bsData = BitStream()
                bsWrap:Write16(bsData, vMy.ID) 
                bsWrap:Write8(bsData, animlib.capacity) 
                bsWrap:WriteBuf(bsData, animlib, animlib.capacity)
                bsWrap:Write8(bsData, animname.capacity) 
                bsWrap:WriteBuf(bsData, animname, animname.capacity)
                bsWrap:WriteFloat(bsData, 4.1)        -- fDelta
                bsWrap:WriteBool(bsData, false)      -- loop
                bsWrap:WriteBool(bsData, true)      -- lock X
                bsWrap:WriteBool(bsData, true)      -- lock Y
                bsWrap:WriteBool(bsData, false)      -- Freeze
                bsWrap:Write32(bsData, 1)           -- Time
                EmulRPC(86,bsData)
                bsWrap:Reset(bsData)
            end
        ...
        function send.Vehicle(vehicleID)
                ...
                local packedValue = bit.lshift(0, 6) + 1
                bsWrap:Write8(bsData, packedValue) 

                packedValue = bit.lshift(0, 6) + 0
                bsWrap:Write8(bsData, packedValue) 
        ...
        function send.PassengerSync(X, Y, Z, vEnPos, weapon)
                ...
                local packedValue = bit.lshift(0, 6) + 1
                bsWrap:Write8(bsData, packedValue) 
                packedValue = bit.lshift(0, 6) + weapon
                bsWrap:Write8(bsData, packedValue) 
        ...
        function send.inCarSync(X, Y, Z, vEnPos, vehicle)
                ...
                bsWrap:Write8(bsData, vMy.HP)
                bsWrap:Write8(bsData, vMy.Armor)
                local packedValue = bit.lshift(additional_key, 6) + weapon_id
                bsWrap:Write8(bsData, packedValue) 
        ...
        function send.onFootSync(data)
                ...
                local packedValue = bit.lshift(data.additional_key, 6) + data.weapon_id
                bsWrap:Write8(bsData, packedValue) 
        ...
        function send.AimSync(data)
                ...
                local packedValue = bit.lshift(data.weaponstate or 0, 6) + data.camzoom or 0
                bsWrap:Write8(bsData, packedValue) 
                ...
                if SHAcKvar.Delayed[1] <= Teleport.PersonalDelay.v then
                    ...
                    if SHAcKvar.Teleporting[1] == 2 then
                        ...
                        if SHAcKvar.Teleporting[4] == 1 then
                            if Extra.Message.TeleportToCheck.v and v.AutoReplyTeleportDelay == 1 then
                                if v.AutoReplyTeleportDelayText ~= " " then
                                    Utils:SayChat(v.AutoReplyTeleportDelayText)
                                end
                                v.AutoReplyTeleportDelayText = nil
                                v.AutoReplyTeleportDelay = 0  
                            end
                        end
                        for i = 0, 26 do
                        ...
                        if distancefromcheckpoint < maxLength and not isNan(distancefromcheckpoint) then
                            ...
                            if Players:Driving(Players:getLocalID()) then
                                ...
                                send.onFootSync(OnFootData)
                                --set.PlayerPos(OnFootData.X, OnFootData.Y, OnFootData.Z)
                            end
        ...
        function send.DetonatorCrasher()
                local bsData = BitStream()
                ...
                local packedValue = bit.lshift(0, 6) + 40
                bsWrap:Write8(bsData, packedValue) 
                ...
                for i = 0, 6 do
                    ...
                    local packedValue = bit.lshift(weapon_state, 6) + cam_zoom
                    bsWrap:Write8(bsData, packedValue) 
    ...
    --RPC/PACKET
        local function OnReceivePacket(packetId, bsData)
                if Panic.EveryThingExceptVisuals.v == false then --and v.InvisibleCar ~= nil and v.InvisibleCar ~= 1 then
                    local Packet_ID = bsWrap:Read8(bsData)
                    local PlayerID = bsWrap:Read16(bsData)
                    if packetId == 200 then         -- Driver Sync
                        local ICdata = vMy.ICData
                        ...
                        local byteValue = bsWrap:Read8(bsData) 
                        local additional_key = bit.rshift(byteValue, 6)
                        local weapon_id = bit.band(byteValue, 0x3F)
                    ...
                    elseif packetId == 203 then     -- Aim Sync
                        --Read
                        ...
                        local byteValue = bsWrap:Read8(bsData) 
                        local weapon_state = bit.rshift(byteValue, 6)
                        local cam_zoom = bit.band(byteValue, 0x3F)
                        local aspect_ratio = bsWrap:Read8(bsData) 
                    elseif packetId == 206 then     -- Bullet Sync
                    ...
                    elseif packetId == 207 then     -- Onfoot Sync
                    ...
                    elseif packetId == 208 then     -- Markers Sync
                        if RadarHack.PlayerMarkers.v then
                            return false
                        end
                    elseif packetId == 209 then     -- Unoccupied Sync
                        --Anti RollCrasher
                        local vehicle_id = bsWrap:Read16(bsData)
        ...
        local function OnReceiveRPC(rpcId, bsData)
                if Panic.EveryThingExceptVisuals.v == false then
                   bsWrap:ResetReadPointer(bsData)  
                    ...
                    elseif rpcId == 15 then     -- TogglePlayerControllable 
                        if Vehicle.DriveNoLicenseFakeData.v and v.enteringvehicle == 1 then
                            return false
                        end
                    elseif rpcId == 24 then     -- SetVehicleParamsEx 
                    ...
                    elseif rpcId == 26 then     -- PlayerEnterVehicle 
                    ...
                    elseif rpcId == 32 then     -- WorldPlayerAdd 
                        local wPlayerID = bsWrap:Read16(bsData)
                    ...
                    elseif rpcId == 34 then     -- SetPlayerSkillLevel 
                        if Extra.SetWeaponSkill.v then
                            return false
                        end
                    elseif rpcId == 35 then     -- SetPlayerDrunkLevel 
                        if Extra.Mobile.v then
                            return false
                        end
                    elseif rpcId == 38 then     -- SetRaceCheckpoint 
                        local Type = bsWrap:Read8(bsData)
                        local floatX = bsWrap:ReadFloat(bsData)
                        local floatY = bsWrap:ReadFloat(bsData)
                        local floatZ = bsWrap:ReadFloat(bsData)
                        SHAcKvar.CheckpointSave = CVector(floatX, floatY, floatZ)
                    elseif rpcId == 44 then     -- CreateObject
                        --local wObjectID = bsWrap:Read16(bsData)
                        --local ModelID = bsWrap:Read32(bsData)
                        --if ModelID == 385 then
                        --    return false
                        --end
                    elseif rpcId == 68 then     -- SetSpawnInfo 
                    ...
                    elseif rpcId == 71 then     -- RemovePlayerFromVehicle 
                        if v.enteringvehicle == 1 and Vehicle.DriveNoLicenseFakeData.v then
                            return false
                        end
                    elseif rpcId == 86 then     -- ApplyPlayerAnimation 
                    ...
                    elseif rpcId == 87 then     -- ClearPlayerAnimation 
                        if Movement.NoAnimations.v then
                            return false
                        end
                        if Vehicle.DriveNoLicenseFakeData.v and v.enteringvehicle == 1 then
                    ...
                    elseif rpcId == 93 then     -- SendClientMessage 
                        if Extra.AutoReply[0].v and Extra.AutoReply[1].v then
                            ...
                            if buf.v ~= nil then
                                ...
                                if cleanedText ~= "" then
                                    ...
                                    local replyText = Extra.Reply[1].v
                                    local messages = {}
                                    local replies = {}
                                    for message in string.gmatch(searchText, "([^;]+)") do
                                        table.insert(messages, message)
                                    end
                                    for reply in string.gmatch(replyText, "([^;]+)") do
                                        table.insert(replies, reply)
                                    end
                                    for i, message in ipairs(messages) do
                                        local reply = replies[i] or ""
                                        if string.find(cleanedText, message, 1, true) then
                                            if Extra.Message.TeleportToCheck.v then
                                                if SHAcKvar.CheckpointSave ~= 0.0 then
                                                    v.AutoReplyTeleportDelay = 1
                                                    v.AutoReplyTeleportDelayText = reply
                                                    break
                                                else
                                                    if reply ~= " " then
                                                        Utils:SayChat(reply)
                        ...
                        --    return false
                        --end
                    elseif rpcId == 101 then    -- ChatMessage
                        if Extra.AutoReply[0].v and Extra.AutoReply[1].v then
                            local PlayerID = bsWrap:Read16(bsData)
                            if PlayerID ~= vMy.ID then
                    ...
                    elseif rpcId == 103 then    -- SendClientCheck
                        ...
                        --return false
                    elseif rpcId == 105 then    -- TextDrawSetString 
                        local wTextDrawID = bsWrap:Read16(bsData)
                        if Extra.AutoReply[0].v and Extra.AutoReply[2].v then
                            ...
                            if buf.v ~= nil then
                                ...
                                if cleanedText ~= "" then
                                    ...
                                    local replyText = Extra.Reply[2].v
                                    local messages = {}
                                    local replies = {}
                                    for message in string.gmatch(searchText, "([^;]+)") do
                                        table.insert(messages, message)
                    ...
                    elseif rpcId == 106 then    -- UpdateVehicleDamageStatus 
                    ...
                    elseif rpcId == 107 then    -- SetCheckpoint 
                        local floatX = bsWrap:ReadFloat(bsData)
                        local floatY = bsWrap:ReadFloat(bsData)
                        local floatZ = bsWrap:ReadFloat(bsData)
                        SHAcKvar.CheckpointSave = CVector(floatX, floatY, floatZ)
                        bsWrap:Reset(bsData)
                    elseif rpcId == 128 then    -- RequestClass 
                        if SHAcKvar.RequestingSpawn ~= 0 then
                            --set.PlayerPos(SHAcKvar.SavePosForSpawn.fX, SHAcKvar.SavePosForSpawn.fY, SHAcKvar.SavePosForSpawn.fZ)
                            return false
                        end
                    elseif rpcId == 134 then    -- ShowTextDraw 
                        local wTextDrawID = bsWrap:Read16(bsData) 
                        if Extra.AutoReply[0].v and Extra.AutoReply[2].v then
                    ...
                    elseif rpcId == 135 then    -- HideTextDraw 
                        local wTextDrawID = bsWrap:Read16(bsData)
                        if v.ShowDraws[0] == wTextDrawID or v.ShowDraws[1] == wTextDrawID then
                            return false
                        end
                    elseif rpcId == 139 then    -- InitGame 
                    ...
                    elseif rpcId == 153 then    -- SetPlayerSkin 
                        if Movement.ForceSkin.v then
                            return false
                        end
                    elseif rpcId == 156 then    -- SetInterior 
                        local interior = bsWrap:Read8(bsData) 
                        SHAcKvar.Interior = interior
                    
                    elseif rpcId == 159 then    -- SetVehiclePos 
                        local vehicle = bsWrap:Read16(bsData)
                        local floatX = bsWrap:ReadFloat(bsData)
                        local floatY = bsWrap:ReadFloat(bsData)
                        local floatZ = bsWrap:ReadFloat(bsData)
                    ...
                    elseif rpcId == 163 then    -- WorldPlayerRemove 
                        if Vehicle.DriveNoLicense.v then
                            return false
                        end

                    elseif rpcId == 164 then    -- WorldVehicleAdd 
                        local vehicle = bsWrap:Read16(bsData) 
                        local ModelID = bsWrap:Read32(bsData) 
                        local X = bsWrap:ReadFloat(bsData) 
                        local Y = bsWrap:ReadFloat(bsData) 
                    ...
                    elseif rpcId == 165 then    -- WorldVehicleRemove 
                        if Vehicle.DriveNoLicense.v then
                            return false
                        end

                    elseif rpcId == 168 then    -- CameraTarget 
                ...
                if Panic.EveryThingExceptVisuals.v == false then
                    ...
                    if packetId == 200 then         -- Driver Sync
                        ...
                        --Read
                            ...
                            local siren_state = bsWrap:Read8(bsData) 
                            local landing_gear_state = bsWrap:Read8(bsData) 
                            local trailer_id = bsWrap:Read16(bsData) 
                            local train_speed = bsWrap:ReadFloat(bsData)
                            bsWrap:Reset(bsData)
                        ...
                        if v.InvisibleCar == 1 and vMy.Vehicle == 1999 then
                            ...
                            bsWrap:Write8(bsData, vMy.HP)  
                            bsWrap:Write8(bsData, vMy.Armor)  
                            local packedValue = bit.lshift(0, 6) + weapon_id
                            bsWrap:Write8(bsData, packedValue)  
                            bsWrap:Write8(bsData, 0)  
                        ...
                        if Troll.FakePos.Enable.v and Troll.FakePos.InCar.v or Vehicle.LimitVelocity.v or Troll.FuckSync.v or Extra.Mobile.v then
                            --RVanka
                                ...
                                bsWrap:Write8(bsData, siren_state)
                                bsWrap:Write8(bsData, landing_gear_state)
                                bsWrap:Write16(bsData, trailer_id)
                                if Extra.Mobile.v then
                                    bsWrap:WriteFloat(bsData, 0)
                                else
                                    bsWrap:WriteFloat(bsData, train_speed)
                    ...
                    elseif packetId == 204 then     -- Weapon Update
                        ...
                        SendPacket(204, bsData)
                        return false
                    elseif packetId == 205 then     -- Status Update 
                        if Extra.Mobile.v then
                            return false
                        end
                    elseif packetId == 206 then     -- Bullet Sync
                    ...
                    elseif packetId == 207 then     -- Onfoot Sync
                        ...
                        --Read
                            ...
                            if special_action == 4 and v.InvisibleCar == 1 then
                                special_action = 0
                                v.InvisibleCar = 2
                            end
                            local velocity_x = bsWrap:ReadFloat(bsData)  
                        ...
                        --
                            ...
                            SHAcKvar.Teleporting[1] == 1 or SHAcKvar.rVankanEWVAR ~= 0 then
                                ...
                                if v.EmulateC == 1 or SHAcKvar.CJWalk == 2 and Movement.bUseCJWalk.v == true or Troll.FakePos.Enable.v or Troll.FuckSync.v or Troll.TrollWalk.v or Extra.Mobile.v or Extra.AntiSniper.v or
                                ...
                                KeyToggle.Silent.v == 1 and v.SilentPlayerID ~= -1 and Players:isPlayerStreamed(v.SilentPlayerID) or Extra.fuckKeyStrokes.Enable.v or v.InvisibleCar == 2 then
                                    vEnPos = -1
                                    if Players:isPlayerStreamed(Players:getNearestPlayer()) then
                                        vEnPos = Players:getPlayerPosition(Players:getNearestPlayer())
                                    end
                                    if v.EmulateC == 1 then
                                        if bit.band(keys, 0x0002) == 0 then
                                            keys = keys + 2
                                        end
                    ...
                    elseif packetId == 210 then     -- Trailer Sync
                        Vehicle.SaveTrailer = bsWrap:Read16(bsData) 
                        local ic = vMy.ICData
                        Vehicle.TrailerToVehicle = ic.VehicleID

                    elseif packetId == 211 then     -- Passenger Sync
                        SHAcKvar.DamagerVehicleID = bsWrap:Read16(bsData) 
                        local byteValue = bsWrap:Read8(bsData) 
                        local drive_by = bit.rshift(byteValue, 6)
                        local seat_id = bit.band(byteValue, 0x3F)
                        SHAcKvar.DamagerToggleH = seat_id
                        byteValue = bsWrap:Read8(bsData)
                        local additional_key = bit.rshift(byteValue, 6)
                        local weapon_id = bit.band(byteValue, 0x3F)
                        local health = bsWrap:Read8(bsData) 
                        local armour = bsWrap:Read8(bsData) 
        ...
        local function OnSendRPC(rpcId, bsData)
                if Panic.EveryThingExceptVisuals.v == false then
                    ...
                    elseif rpcId == 25 then     -- ClientJoin 
                    ...
                    elseif rpcId == 50 then     -- SendCommand 
                        ...
                        if Commands.CreateVeh.v then
                            if Commands.CreateVehNormal.v == splitted[1] or Commands.CreateVehInvisible.v == splitted[1] then
                                ...
                                local vehicleId
                                if splitted[1] == Commands.CreateVehInvisible.v or v.InvisibleCar ~= 0 then
                                    vehicleId = 1999
                                else
                                    local ICData = vMy.ICData
                    ...
                    elseif rpcId == 52 then     -- SendSpawn 
                        SHAcKvar.canSlide = 0
                        Timer.Slide[0] = 0

                    elseif rpcId == 103 then    -- ClientCheck 
                    ...
                    elseif rpcId == 106 then    -- VehicleDamaged 
                        if Extra.Mobile.v then
                            return false
                        end
                    
                    elseif rpcId == 115 then    -- GiveTakeDamage
                    ...
                    elseif rpcId == 119 then    -- Map Marker
                        local floatX = bsWrap:ReadFloat(bsData)
                        local floatY = bsWrap:ReadFloat(bsData)
                        local floatZ = bsWrap:ReadFloat(bsData)
                    ...
                    elseif rpcId == 129 then    -- RequestSpawn
                        SHAcKvar.canSlide = 0
                        Timer.Slide[0] = 0

                    elseif rpcId == 154 then    -- ExitVehicle 
                        local vehicle = bsWrap:Read16(bsData)
                        if Vehicle.FastExit.Enable.v and Vehicle.FastExit.Type.v == 1 then
                            if vAmI.Driver or vAmI.Passenger then
                                bsWrap:Reset(bsData)
...
--! Mainloop
    ...
    --Timers Variables
        if(getVars.update(deltaTime)) then
            get.AllMyVariables()
    ...
    --Movement
            ...
            if Movement.Slide.Enable.v then
                ...
                Timer.GunC == 0 and Timer.Slide[0] > 2 and Movement.Slide.AutoC.v then
                    if not vAmI.Passenger and not vAmI.Driver then
                        ...
                        if SHAcKvar.FiredGun ~= 26 then
                            if Movement.Slide.OnKey.v == false and not Utils:IsKeyDown(65) and not Utils:IsKeyDown(87) and not Utils:IsKeyDown(83) and not Utils:IsKeyDown(68) or Movement.Slide.OnKey.v and not Utils:IsKeyDown(Movement.Slide.Key.v) then
                        ...
                        local hFist = Utils:readMemory(CPedST+0x480, 4, false)
                        ...
                        SHAcKvar.Switch == SHAcKvar.SwitchVelocity[1] and weaponInfo[SHAcKvar.FiredGun].twohanded then
                            ...
                            if SHAcKvar.Switch > -1 and SHAcKvar.Switch < 1 then
                                Utils:writeMemory(hFist+0x84, 1, 1, false)
                            end
                        end
                        if SHAcKvar.Switch == SHAcKvar.SwitchVelocity[0] then
                            if SlideWeapon ~= nil then
                            ...
                            Utils:writeMemory(hFist+0x84, 0, 1, false)
                        end
        ...
        --NoVehicleRam
            if Movement.NoRam.v then
                local vData = Players:getOnFootData(vMy.ID)
                if vData.Health ~= 0 then
                    if vMy.OFData.sCurrentAnimationID >= 1208 and vMy.OFData.sCurrentAnimationID <= 1211 then
                        set.ClearPlayerAnimations()
                    end
                end
            end
        --NoFall
                if vMy.OFData.sCurrentAnimationID >= 1128 and vMy.OFData.sCurrentAnimationID <= 1130 and v.NoFall == 0 then
                    ...
                    if Utils:IsLineOfSightClear(CVector(vMyBone.fX, vMyBone.fY, vMyBone.fZ), CVector(vMyBone.fX, vMyBone.fY, vMyBone.fZ-2.5), true, true ,false, true, false, false, false) == false then
                        if Movement.NoFallNodamage.v and Movement.NoFall.v then
                            if Godmode.Player.Enable.v == false or Godmode.Player.Enable.v and Godmode.Player.Collision.v == false then
                                Utils:writeMemory(CPedST+0x42, 16, 1, false)
                            end
                        end
                ...
                if v.NoFall >= 2 then
                    ...
                    if Movement.NoRam.v then
                        if vMy.OFData.sCurrentAnimationID == 1208 or vMy.OFData.sCurrentAnimationID == 1209 then
                            set.ClearPlayerAnimations()
                        end
                    end
                end
    --Miscellaneous
        --noReload
            --local vMyWeapon = Players:getPlayerWeapon(vMy.ID)
            --local CWeapon = CPedST + 0x5A0
            --local current_cweapon = CWeapon + (weaponInfo[vMyWeapon].slot) * 0x1C
            --Utils:writeMemory(current_cweapon + 4, 0, 4, false)
        --AutoC
            if Extra.AutoC.Enable.v then
                local vMyWeapon = Players:getPlayerWeapon(vMy.ID)
                if vMyWeapon == 24 then
                    local pData = Players:getOnFootData(vMy.ID)
                    local Keys = pData.sKeys
                    ...
                    if autoC ~= nil and autoC ~= 0 and autoC ~= 1 then
                        if autoC.update(deltaTime) then 
                            ...
                            set.PlayerAnimation(animlib, animname)
        ...
        --Vehicles
            ...
            --FastExitLegit
                if Vehicle.FastExit.Enable.v and Vehicle.FastExit.Type.v == 0 then
                    --if vAmI.Driver or vAmI.Passenger then
                        local CVeh = Utils:readMemory(0xB6F980, 4, false)
                        local Exit
                        if CVeh ~= 0 then
                            Exit = Utils:readMemory(CVeh+0x36, 1, false)
                        end
                        if ExitTimer ~= nil and ExitTimer ~= 0 and ExitTimer.update(deltaTime) then
                            set.ClearPlayerAnimations()
                            if v.InvisibleCar ~= 0 then
                                v.InvisibleCar = 2
                            end
                            ExitTimer = 0
                        end
                        if Exit == 74 then
                            if ExitTimer == 0 or ExitTimer == nil then
                                ExitTimer = Timers(Vehicle.FastExit.Delay.v)
                            end
                        end
                    --end
                end
            ...
            --VehicleSpam
                if Utils:IsKeyDown(87) then
                    ...
                    if memory.CVehicle.Surface ~= 0 then
                        ...
                        if vehicleInfo[vModel].type == VehicleType.Bike then
                            if Vehicle.Bike.Enable.v then
                                ...
                                if SHAcKvar.VehicleSpam > Vehicle.Bike.Delay.v then
                                    SHAcKvar.VehicleSpam = 0
                                end
                                if SHAcKvar.VehicleSpam < Vehicle.Bike.Delay.v*0.5 then
                            ...
                            if vehicleInfo[vModel].type == VehicleType.Bicycle then
                                if Vehicle.Bicycle.Enable.v then
                                    ...
                                    if SHAcKvar.VehicleSpam > Vehicle.Bicycle.Delay.v then
                                        SHAcKvar.VehicleSpam = 0
                                    end
                                    if SHAcKvar.VehicleSpam < Vehicle.Bicycle.Delay.v*0.5 then
                    ...
                    if SHAcKvar.VehicleSpam > Vehicle.Bike.Delay.v*0.5 or SHAcKvar.VehicleSpam > Vehicle.Bicycle.Delay.v*0.5 then
                        Utils:writeMemory(0xB72ED6, 0, 1, false)
                        Utils:writeMemory(0xB72D76, 0, 1, false)
                        SHAcKvar.VehicleSpam = 0
                    end
        ...
        --Send CMD
            if Extra.SendCMD.Enable.v and get.isPlayerAlive(vMy.ID) then
                local vData = Players:getOnFootData(vMy.ID)
                if Extra.SendCMD.HP.v < 100 and vData.Health < Extra.SendCMD.HP.v or
                Extra.SendCMD.HP.v >= 100 and vData.Armor < Extra.SendCMD.Armour.v then
                    ...
                    v.SendCMD = 0
                    SendCMD = Timers(Extra.SendCMD.FirstDelay.v)
                end
            end
        --PickUP
            if Extra.PickUP.Enable.v and get.isPlayerAlive(vMy.ID) then
                local vData = Players:getOnFootData(vMy.ID)
                if Extra.PickUP.HP.v < 100 and vData.Health < Extra.PickUP.HP.v or
                Extra.PickUP.HP.v >= 100 and vData.Armor < Extra.PickUP.Armour.v then
        ...
        --Teleports
            if Teleport.Enable.v or Extra.Message.TeleportToCheck.v and v.AutoReplyTeleportDelay == 1 then
            --Teleport To Objects
            ...
            --Checkpoint
                if Teleport.toCheckpoint.v or Extra.Message.TeleportToCheck.v and v.AutoReplyTeleportDelay == 1 then
                    if SHAcKvar.CheckpointSave ~= 0.0 then 
                        if Teleport.toCheckpoint.v and Utils:IsKeyDown(Teleport.CheckpointKey.v) or Extra.Message.TeleportToCheck.v and v.AutoReplyTeleportDelay == 1 then 
                            SHAcKvar.Teleporting[4] = 1
                            TeleportPlayerTo(SHAcKvar.CheckpointSave)
                        else
                            if SHAcKvar.Teleporting[4] == 1 then
                                if Extra.Message.TeleportToCheck.v and v.AutoReplyTeleportDelay ~= 1 or Teleport.toCheckpoint.v and not Utils:IsKeyDown(Teleport.CheckpointKey.v) then
                                    SHAcKvar.Teleporting[1] = 2
                                    TeleportPlayerTo(SHAcKvar.CheckpointSave)
                                end
                            end
        ...
        if SHAkMenu.Saved == 1 or SHAcKvar.Teleporting[1] == 1 then
            ...
            if v.Troller ~= -1 and Vehicle.AntiCarJack.v then
                if Players:isPlayerStreamed(v.Troller) then
                    ...
                    Render:DrawText( Players:getPlayerName(v.Troller).."(".. v.Troller ..")",X+315,Y+15,Players:getPlayerColor(v.Troller))
                    Y = Y - 15
                else
                    v.Troller = -1
                end
...
--! Menu
    ...
    --Format
        ...
        Menu:SameLine(SHAkMenu.menutransitorstaticreversed+5,SHAkMenu.menutransitorstaticreversed+5) Menu:Combo(" ",SHAkMenu.Menu,"MENU\0AIM\0MOVEMENT\0VEHICLE\0MISCELLANEOUS\0VISUALS\0TROLL\0NOPS\0\0",6)
        Menu:Separator()
    --Aim
        if SHAkMenu.Menu.v == 1 then
        ...
        if SHAkMenu.Menu.v == 2 then
            ...
            --Player
                ...
                if Others == true then
                    ...
                    Menu:Text("") Menu:SameLine(SHAkMenu.menutransitorstaticreversed,SHAkMenu.menutransitorstaticreversed) Menu:CheckBox2("No Vehicle Ram", Movement.NoRam)
            ...
            --Slide
                ...
                if SlideList == true then
                    ...
                    Menu:PushItemWidth(100)
                        ...
                        Menu:Text("") Menu:SameLine(SHAkMenu.menutransitorstaticreversed+10,SHAkMenu.menutransitorstaticreversed+10) Menu:CheckBox2("Dont Switch Weapon ##1", Movement.Slide.DontSwitchWeap1)
                        if not Movement.Slide.DontSwitchWeap1.v then
                    ...
                    if Movement.Slide.PerWeap.v then
                        ...
                        Menu:Text("") Menu:SameLine(SHAkMenu.menutransitorstaticreversed+10,SHAkMenu.menutransitorstaticreversed+10) Menu:CheckBox2("Dont Switch Weapon ##2", Movement.Slide.DontSwitchWeap2)
                        if not Movement.Slide.DontSwitchWeap2.v then
        ...
        if SHAkMenu.Menu.v == 3 then
            ...
            Menu:Text("") Menu:SameLine(SHAkMenu.menutransitor+3,SHAkMenu.menutransitor+3) 
                ...
                if Vehicle.FastExit.Type.v == 0 then
                    Menu:SameLine(SHAkMenu.menutransitorstaticreversed+95,SHAkMenu.menutransitorstaticreversed+95) Menu:SliderInt("Delay##23",Vehicle.FastExit.Delay, 100, 1000)
                end
        ...
        if SHAkMenu.Menu.v == 4 then
            ...
            --Extra
                ...
                if ExtraList == true then
                    Menu:Text("") Menu:SameLine(SHAkMenu.menutransitorstaticreversed,SHAkMenu.menutransitorstaticreversed) Menu:CheckBox2("Auto +C", Extra.AutoC.Enable)
                    Menu:SameLine(SHAkMenu.menutransitorstaticreversed,SHAkMenu.menutransitorstaticreversed) Menu:Combo("C Type", Extra.AutoC.Type, "Normal\0Don't Restore\0", 600)
                    Menu:Separator()
                    ...
                    if Extra.SendCMD.Times.v > 1 then
                        Menu:Text("") Menu:SameLine(SHAkMenu.menutransitorstaticreversed+5,SHAkMenu.menutransitorstaticreversed+5) Menu:SliderInt("First Delay##2", Extra.SendCMD.FirstDelay, 0, 20000)
                    ...
                    Menu:Text("") Menu:SameLine(SHAkMenu.menutransitorstaticreversed+5,SHAkMenu.menutransitorstaticreversed+5) Menu:CheckBox2("TP To Checkpoint", Extra.Message.TeleportToCheck)
                    Menu:Separator()
        ...
        if SHAkMenu.Menu.v == 5 then
            ...
            --WallHack
                ...
                if WallHackList == true then
                    ...
                    if PingPoint.Enable.v then
                        Menu:Text("") Menu:SameLine(SHAkMenu.menutransitorstaticreversed+5,SHAkMenu.menutransitorstaticreversed+5)Menu:CheckBox2("Sceleton", PingPoint.Sceleton)
                    end
                end
            --Stream
                Menu:Separator()
    ...
    --Config
        if SHAkMenu.Menu.v == 0 then
            ...
            --Delete
                ...
                Menu:Text("  ") Menu:SameLine(SHAkMenu.menutransitorstaticreversed+75,SHAkMenu.menutransitorstaticreversed+75) Menu:CheckBox("Unload With Delete",SHAkMenu.Unload)
            --shackled.lua Indicator
                Menu:Separator()
...
--! HOOKS
        Hooks:Register(15, Reload) 
        Hooks:Register(14, Unload) 
